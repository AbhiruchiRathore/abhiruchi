...
<Link href="/" className="flex flex-col">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              className="hidden items-center gap-1 rounded-full border border-border px-2.5 py-1 text-xs font-medium text-foreground/70 transition-colors hover:border-violet-deep/30 sm:flex"
