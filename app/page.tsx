    ...
    <section className="relative overflow-hidden bg-[#FBF9F7]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-6 pb-12 sm:pt-10 sm:pb-16 lg:px-6 lg:pt-14 lg:pb-20">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-5">
          ...
          >
            <div className="relative h-44 sm:h-64 lg:h-72">
              <Image
                src="/hero-paid-media.webp"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                ...
                <p className="mt-0.5 text-[11px] text-white/80 sm:text-xs">
                  Ads that convert, not just click
                </p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="relative h-44 sm:h-64 lg:h-72">
              <Image
                src="/hero-aeo-geo.webp"
                alt="AEO and GEO optimization for AI search"
                fill
                sizes="(max-width: 640px) 50vw, 33vw"
                className="object-cover transition-transform duration-500 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-maroon-rich/70 via-maroon-rich/10 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                <h3 className="font-display text-base font-bold text-white sm:text-lg">
                  AEO &amp; GEO
                </h3>
                <p className="mt-0.5 text-[11px] text-white/80 sm:text-xs">
                  Get your brand on ChatGPT
                </p>
              </div>
            </div>
          </Link>
  ...
  const steps = [
    {
      ...
      title: '1. Choose',
      description: 'Browse our services and add what you need to your cart.',
    },
    {
      icon: CreditCard,
      title: '2. Pay',
      description: 'Make a secure payment with multiple options.',
    },
    {
      icon: Rocket,
      title: '3. We Deliver',
      description: 'Our experts get to work and deliver on time.',
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        <div className="mb-6 flex flex-col gap-3 sm:mb-8 sm:flex-row sm:items-end sm:justify-between">
          ...
          <p className="text-xs text-muted-foreground sm:text-sm">
            No contracts &nbsp;•&nbsp; Transparent pricing &nbsp;•&nbsp; Expert delivery
          </p>
        </div>
