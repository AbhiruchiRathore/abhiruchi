              ...
              <div className="sticky top-20 rounded-xl border border-border bg-violet-soft/20 p-5">
                ...
                <div className="mt-4 space-y-2 border-t border-border pt-4">
                  ...
                  <div className="flex justify-between border-t border-border pt-2">
                    ...
                    <span className="font-body text-xl font-bold text-violet-deep">
                      ${formatPrice(total)}
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-4 rounded-lg bg-maroon-soft/30 p-3">
                  <p className="text-xs font-medium text-foreground">
                    Your cart is ready. Your brand is next.
                  </p>
                  <p className="mt-1 text-xs text-muted-foreground">
                    No payment. No commitment upfront.
                  </p>
                  <p className="mt-1 text-xs text-muted-foreground">
                    Hit Submit Request, and we&rsquo;ll reach out to confirm the details and get started.
                  </p>
                </div>
              </div>
            </div>
