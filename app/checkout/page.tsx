...
const ORDERS_KEY = 'abhiruchi-orders';
...
export default function CheckoutPage() {
  ...
  const handleFinalSubmit = async (e: React.FormEvent) => {
    ...
    const id = 'ABH-' + Date.now().toString(36).toUpperCase().slice(-8);
    ...
    formData.append('from_name', 'Abhiruchi Website');
              ...
              <div className="sticky top-20 rounded-xl border border-border bg-violet-soft/20 p-5">
                ...
                <div className="mt-4 border-t border-border pt-4">
                  ...
                  <p className="mt-1.5 text-xs text-muted-foreground">
                    Try: WELCOME10, GROWTH20, ABHIRUCHI15
                  </p>
                </div>
