...
const steps = [
  {
    ...
    number: '1',
    title: 'Choose',
    titleFull: 'Browse & Select',
    description: 'Browse our catalog of digital marketing services. Add exactly what you need to your cart — no minimums, no contracts.',
    details: [
  ...
  },
  {
    ...
    number: '2',
    title: 'Pay',
    titleFull: 'Secure Checkout',
    description: 'Checkout securely with multiple payment options. Your information is encrypted and protected at every step.',
    details: [
  ...
  },
  {
    ...
    number: '3',
    title: 'We Deliver',
    titleFull: 'Expert Delivery',
    description: 'Our expert marketers get to work immediately. You receive updates throughout and your deliverables on time.',
    details: [
      'Brief questionnaire sent instantly',
